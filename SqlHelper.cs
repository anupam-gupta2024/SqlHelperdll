...
namespace DataAccess
{
    public sealed class SqlHelper
    {
        ...
        {
            //connectionString = @"Persist Security Info=False;User ID=allen24109lg;PWD=CarEh34Pwd;Initial Catalog=AllenRegistrationRoot;Data Source=ACI-CP6-023\SQL2008CHETAN";
        ...
        public static SqlDataReader ExecuteReader(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            ...
            try
            {
                dr = ExecuteReader(cn, null, commandType, commandText, commandParameters, SqlConnectionOwnership.Internal);
            }
            catch
            {
                cn.Close();
